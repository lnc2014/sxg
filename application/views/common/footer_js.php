...
<script src="<?php echo $base_js_url?>/jquery.ui.touch-punch.min.js"></script>
<script src="<?php echo $base_js_url?>/jquery.easypiechart.min.js"></script>
<script src="<?php echo $base_js_url?>/jquery.sparkline.min.js"></script>
<script src="<?php echo $base_js_url?>/flot/jquery.flot.min.js"></script>
<script src="<?php echo $base_js_url?>/flot/jquery.flot.pie.min.js"></script>
<script src="<?php echo $base_js_url?>/flot/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->
<script src="<?php echo $base_js_url?>/ace-elements.min.js"></script>
<script src="<?php echo $base_js_url?>/ace.min.js"></script>
