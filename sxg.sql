...
insert  into `sxg_address`(`address_id`,`user_id`,`repair_user_id`,`name`,`mobile`,`sex`,`province`,`city`,`area`,`street`,`is_default`,`create_time`,`update_time`) values (1,'1',0,'李农成','158899872592',1,'广东省','深圳市','南山区','华侨新村',1,NULL,NULL),(2,'',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL),(3,'1',0,NULL,'15899872592',1,'吉林','吉林','昌邑区','环保',1,1466528520,1466528520),(4,'1',0,NULL,'15899872592',0,'内蒙古','包头','昆都仑区','环保',1,1466528584,1466528584),(5,'1',0,'请求','15101226681',1,'江苏','无锡','崇安区','李农成',1,1466528609,1466528609),(6,'1',0,'李农成','15899872592',0,'江苏','南京','白下区','南山',1,1466565378,1466565378),(7,'1',0,'杨姣','18698725652',0,'天津','和平区','','龙华',1,1466924410,1466924410);
